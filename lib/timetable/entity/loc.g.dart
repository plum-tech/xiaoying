...
TimetableDayLoc _$TimetableDayLocFromJson(Map<String, dynamic> json) =>
    TimetableDayLoc(
      mode: $enumDecode(_$TimetableDayLocModeEnumMap, json['mode']),
      posInternal: json['pos'] == null
          ? null
          : TimetablePos.fromJson(json['pos'] as Map<String, dynamic>),
      dateInternal: json['date'] == null
          ? null
          : DateTime.parse(json['date'] as String),
    );

Map<String, dynamic> _$TimetableDayLocToJson(
  TimetableDayLoc instance,
) => <String, dynamic>{
